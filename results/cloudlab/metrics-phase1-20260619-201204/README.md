...
- Run ID: `metrics-phase1-20260619-201204`
- Application: `application_1781911776702_0002`
- Query: `0`
- Input topic: `nexmark-metrics-phase1-20260619-201204`
- Result topic: `nexmark-metrics-phase1-20260619-201204-results`
- Executor config: `configs/cloudlab/nemo-yarn-kafka-1source-cap4-8compute.json`
- Work dir: `/tmp/nx-metrics-phase1-20260619-201204`
- AM host: `node11`
- Date: 2026-06-19T20:19:17-05:00
...
- Input Kafka offset total: `5000000`
- Result Kafka offset total: `0`
- Final source count: `0`
- Max input/source lag: `0`
- Max input/result lag: `5000000`
- Max scaler queue: `4999900`
...
```bash
python3 scripts/cloudlab/plot_metrics.py /users/akash01/incubator-nemo/results/cloudlab/metrics-phase1-20260619-201204
```
