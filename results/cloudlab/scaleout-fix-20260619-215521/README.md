...
- Run ID: `scaleout-fix-20260619-215521`
- Application: `application_1781911776702_0006`
- Query: `0`
- Input topic: `nexmark-scaleout-fix-20260619-215521`
- Result topic: `nexmark-scaleout-fix-20260619-215521-results`
- Executor config: `configs/cloudlab/nemo-yarn-kafka-1source-cap4-8compute.json`
- Work dir: `/tmp/nx-scaleout-fix-20260619-215521`
- AM host: `node10`
- Date: 2026-06-19T21:59:53-05:00
...
- Result Kafka offset total: `6129548`
- Final source count: `7668977`
- Max input/source lag: `9000000`
- Max input/result lag: `3870452`
- Max scaler queue: `2330923`
- Max Kafka queue-time p95: `1442.000` ms
- Scaling decisions: `1`
...
```bash
python3 scripts/cloudlab/plot_metrics.py /users/akash01/incubator-nemo/results/cloudlab/scaleout-fix-20260619-215521
```
