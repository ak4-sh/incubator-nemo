...
- Run ID: `nexmark-q6-warmup-20260627-091117`
- Application: `application_1782530701438_0008`
- Query: `6`
- Completion mode: `source_plus_some_output`
- Input topic: `nexmark-nexmark-q6-warmup-20260627-091117`
- Result topic: `nexmark-nexmark-q6-warmup-20260627-091117-results`
- Kafka consumer group: `nexmark-q6-warmup-20260627-091117-consumer`
- Executor config: `configs/cloudlab/nemo-yarn-kafka-1source-8slot-12compute.json`
- Work dir: `/tmp/nx-nexmark-q6-warmup-20260627-091117`
- AM host: `node10`
- Date: 2026-06-27T09:15:14-05:00
...
- Result Kafka offset total: `76364`
- Final source count: `2500000`
- Max input/source lag: `28839`
- Max input/result lag: `2335512`
- Max scaler queue: `14687`
- Max Kafka queue-time p95: `1951.583` ms
- Scaling decisions: `0`
...
```bash
python3 scripts/cloudlab/plot_metrics.py /users/akash01/incubator-nemo/results/cloudlab/nexmark-q6-warmup-20260627-091117
```
