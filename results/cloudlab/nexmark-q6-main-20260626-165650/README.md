...
- Application: `application_1782444527113_0007`
- Query: `6`
...
- Kafka consumer group: `nexmark-q6-main-20260626-165650-consumer`
- Executor config: `configs/cloudlab/nemo-yarn-kafka-1source-8slot-12compute.json`
- Work dir: `/tmp/nx-nexmark-q6-main-20260626-165650`
- AM host: `node5`
- Date: 2026-06-26T17:09:53-05:00
...
- Result Kafka offset total: `611787`
- Final source count: `23850000`
- Max input/source lag: `0`
- Max input/result lag: `0`
- Max scaler queue: `1592855`
- Max Kafka queue-time p95: `15697.887` ms
- Scaling decisions: `0`
...
```bash
python3 scripts/cloudlab/plot_metrics.py /users/akash01/incubator-nemo/results/cloudlab/nexmark-q6-main-20260626-165650
```
