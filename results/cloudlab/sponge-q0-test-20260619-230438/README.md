...
- Run ID: `sponge-q0-test-20260619-230438`
- Application: `application_1781926211327_0002`
- Query: `0`
- Input topic: `nexmark-sponge-q0-test-20260619-230438`
- Result topic: `nexmark-sponge-q0-test-20260619-230438-results`
- Executor config: `configs/cloudlab/nemo-yarn-kafka-1source-cap4-8compute.json`
- Work dir: `/tmp/nx-sponge-q0-test-20260619-230438`
- AM host: `node9`
- Date: 2026-06-19T23:11:37-05:00
...
- Max input/source lag: `952290`
- Max input/result lag: `6246277`
- Max scaler queue: `1628013`
- Max Kafka queue-time p95: `6140.991` ms
- Scaling decisions: `2`
- Scale-out decisions: `1`
- Scale-in decisions: `1`
- VM task metric rows: `589`
...
```bash
python3 scripts/cloudlab/plot_metrics.py /users/akash01/incubator-nemo/results/cloudlab/sponge-q0-test-20260619-230438
```
