...
- Run ID: `metrics-phase1-fix-20260619-211810`
- Application: `application_1781911776702_0003`
- Query: `0`
- Input topic: `nexmark-metrics-phase1-fix-20260619-211810`
- Result topic: `nexmark-metrics-phase1-fix-20260619-211810-results`
- Executor config: `configs/cloudlab/nemo-yarn-kafka-1source-cap4-8compute.json`
- Work dir: `/tmp/nx-metrics-phase1-fix-20260619-211810`
- AM host: `node10`
- Date: 2026-06-19T21:21:00-05:00
...
- Input Kafka offset total: `1000000`
- Result Kafka offset total: `1000000`
- Final source count: `700100`
- Max input/source lag: `0`
- Max input/result lag: `0`
- Max scaler queue: `0`
- Max Kafka queue-time p95: `249.015` ms
- Scaling decisions: `0`
...
```bash
python3 scripts/cloudlab/plot_metrics.py /users/akash01/incubator-nemo/results/cloudlab/metrics-phase1-fix-20260619-211810
```
