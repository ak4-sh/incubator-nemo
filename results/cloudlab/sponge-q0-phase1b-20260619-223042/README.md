...
- Run ID: `sponge-q0-phase1b-20260619-223042`
- Application: `application_1781926211327_0001`
- Query: `0`
- Input topic: `nexmark-sponge-q0-phase1b-20260619-223042`
- Result topic: `nexmark-sponge-q0-phase1b-20260619-223042-results`
- Executor config: `configs/cloudlab/nemo-yarn-kafka-1source-cap4-8compute.json`
- Work dir: `/tmp/nx-sponge-q0-phase1b-20260619-223042`
- AM host: `node5`
- Date: 2026-06-19T22:37:51-05:00
...
- Max input/source lag: `1826394`
- Max input/result lag: `6037004`
- Max scaler queue: `2145659`
- Max Kafka queue-time p95: `10758.304` ms
- Scaling decisions: `2`
- Scale-out decisions: `1`
- Scale-in decisions: `1`
- VM task metric rows: `582`
...
```bash
python3 scripts/cloudlab/plot_metrics.py /users/akash01/incubator-nemo/results/cloudlab/sponge-q0-phase1b-20260619-223042
```
