...
public final class EvalConf {
  ...
  @NamedParameter(short_name = "fluid", default_value = "false")
  public final class FluidMigration implements Name<Boolean> {
  }

  @NamedParameter(short_name = "fluid_delay", default_value = "1000")
